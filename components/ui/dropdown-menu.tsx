  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        // Success styles
        "data-[variant=success]:text-green-600 data-[variant=success]:focus:bg-green-100 dark:data-[variant=success]:focus:bg-green-800/20 data-[variant=success]:focus:text-green-600 data-[variant=success]:*:[svg]:!text-green-600",
        // Shared styles
